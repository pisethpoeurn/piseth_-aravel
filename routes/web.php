...
Route::get('/showformedit/{id}', 'UserController@editProfile')->name('showformedit');
Route::get('/showformeadd', 'UserController@addformprofile')->name('showadd');
Route::put('/editProfile,{id}', 'UserController@Update')->name('updatePrfile');
Route::get('/deleteProfile/{id}','UserController@delete')->name('delete');
Route::get('/showform', 'UserController@showFormPost')->name('showform');
Route::post('/addPost/{id}', 'UserController@addPosts')->name('addPosts');
Route::get('/showPost', 'UserController@showPost')->name('showPost');
Route::get('/showeditPost,{id}', 'UserController@showFormEditPost')->name('showformeditpost');
